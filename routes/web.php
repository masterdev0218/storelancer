...
use App\Http\Controllers\RapydController;
...
Route::get('shipping/export', [ShippingController::class,'fileExport'])->name('shipping.export');
...
Route::get('store/{slug?}/categorie/{name?}', [StoreController::class,'product'])->name('store.categorie.product');
...
Route::get('/customer',[StoreController::class,'customerindex'])->name('customer.index')->middleware(['auth','XSS']);
Route::get('/customer/view/{id}', [StoreController::class,'customershow'])->name('customer.show');
