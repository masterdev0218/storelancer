...
<?php $__env->startSection('action-btn'); ?>
    <ul class="nav nav-pills cust-nav   rounded  mb-3" id="pills-tab" role="tablist">
        <?php if(Auth::user()->type == 'Owner'): ?>
            <li class="nav-item">
                <a class="nav-link active" id="pills-theme_setting-tab" data-bs-toggle="pill" href="#pills-theme_setting"
                    role="tab" aria-controls="pills-theme_setting" aria-selected="true"><?php echo e(__('Theme Settings')); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-brand_setting-tab" data-bs-toggle="pill" href="#pills-brand-setting"
        ...
        <div class="col-sm-12">
            <?php if(Auth::user()->type == 'Owner'): ?>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade active show" id="pills-theme_setting" role="tabpanel"
                        aria-labelledby="pills-theme_setting">
                        <?php echo e(Form::open(['route' => ['store.changetheme', $store_settings->id], 'method' => 'POST'])); ?>

                        <div class="d-flex mb-3 align-items-center justify-content-between">
                            <h3><?php echo e(__('Theme Settings')); ?></h3>
                                                    ...
                                                    <div class="d-flex mt-2 justify-content-between align-items-center <?php echo e($key == 'theme10' ? 'theme10box' : ''); ?>"
                                                        ...
                                                        <?php if(isset($store_settings['theme_dir']) && $store_settings['theme_dir'] == $key): ?>
                                                            <a href="<?php echo e(route('store.editproducts', [$store_settings->slug, $key])); ?>"
                                                                class="btn btn-primary" id="button-addon2"> <i
                                                                    data-feather="edit"></i> <?php echo e(__('Edit')); ?></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if(auth()->user()->currentPlan->id === 3): ?>
                                            <!-- Rapyd -->
                                            <div class="accordion-item card">
                                                <h2 class="accordion-header" id="heading-rapyd">
                                                    <button class="accordion-button collapsed" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#collapse-rapyd"
                                                        aria-expanded="true" aria-controls="collapse-rapyd">
                                                        <span class="d-flex align-items-center">
                                                            <i class="ti ti-credit-card text-primary"></i>
                                                            <?php echo e(__('Rapyd')); ?>
                                                ...
                                                <div id="collapse-rapyd" class="accordion-collapse collapse"
                                                    aria-labelledby="heading-rapyd" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        <div class="row">
                                                            <div class="col-6 py-2">
                                                            ...
                                                            <div class="col-6 py-2 text-end">
                                                                <div class="form-check form-switch form-switch-right mb-2">
                                                                    <input type="hidden" name="is_rapyd_enabled"
                                                                        value="off">
                                                                    <input type="checkbox" class="form-check-input mx-2"
                                                                        name="is_rapyd_enabled" id="is_rapyd_enabled"
                                                                        <?php echo e(isset($store_settings['is_rapyd_enabled']) && $store_settings['is_rapyd_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                    <label class="form-check-label"
                                                                        for="is_rapyd_enabled"><?php echo e(__('Enable')); ?></label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 pb-4">
                                                                <label class="paypal-label col-form-label"
                                                                    for="rapyd_mode"><?php echo e(__('Rapyd Mode')); ?></label>
                                                                <br>
                                                                <div class="d-flex">
                                                                        ...
                                                                        <div class="border card p-3">
                                                                            <div class="form-check">
                                                                                <label class="form-check-labe text-dark">
                                                                                    <input type="radio"
                                                                                        name="rapyd_mode" value="sandbox"
                                                                                        class="form-check-input"
                                                                                        <?php echo e(!isset($store_settings['rapyd_mode']) || $store_settings['rapyd_mode'] == '' || $store_settings['rapyd_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                                    ...
                                                                    <div class="mr-2">
                                                                        <div class="border card p-3">
                                                                            <div class="form-check">
                                                                                <label class="form-check-labe text-dark">
                                                                                    <input type="radio"
                                                                                        name="rapyd_mode" value="live"
                                                                                        class="form-check-input"
                                                                                        <?php echo e(isset($store_settings['rapyd_mode']) && $store_settings['rapyd_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                                    <?php echo e(__('Live')); ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="rapyd_client_id"
                                                                        class="col-form-label"><?php echo e(__('Client ID')); ?></label>
                                                                    <input type="text" name="rapyd_client_id"
                                                                        id="rapyd_client_id" class="form-control"
                                                                        value="<?php echo e(!isset($store_settings['rapyd_client_id']) || is_null($store_settings['rapyd_client_id']) ? '' : $store_settings['rapyd_client_id']); ?>"
                                                                        placeholder="<?php echo e(__('Client ID')); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="rapyd_secret_key"
                                                                        class="col-form-label"><?php echo e(__('Secret Key')); ?></label>
                                                                    <input type="text" name="rapyd_secret_key"
                                                                        id="rapyd_secret_key" class="form-control"
                                                                        value="<?php echo e(!isset($store_settings['rapyd_secret_key']) || is_null($store_settings['rapyd_secret_key']) ? '' : $store_settings['rapyd_secret_key']); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/settings/index.blade.php ENDPATH**/ ?>