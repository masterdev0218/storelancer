                ...
                <div class="container">
                    <div class="row ">
                        ...
                        <div class="col-lg-9 col-md-12 col-12 justify-content-end">
                            <div class="cart-btns">
                                <a href="<?php echo e(route('store.cart', $store->slug)); ?>" class="active-btn">1 - <?php echo e(__('My Cart')); ?></a>
                                <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>">2 -<?php echo e(__('Customer')); ?></a>
                                <a href="<?php echo e(route('store-payment.payment', $store->slug)); ?>">3 - <?php echo e(__('Payment')); ?></a>
                            </div>
                        </div>
                                        ...
                                        <?php $__currentLoopData = $products['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($product['variant_id'] != 0): ?>
                                                <tr data-id="<?php echo e($key); ?>">
                                                    <td data-label="Product">
                                                        <?php if(!empty($product['image'])): ?>
                                                            <a class="pro-img-cart">
                                                                <img src="<?php echo e($imgpath.$product['image']); ?>">
                                                            </a>
                                                        <?php else: ?>
                                                            <a class="pro-img-cart">
                                                    ...
                                                    <td data-label="Name">
                                                        <a href="<?php echo e(route('store.product.product_view',[$store->slug,$product['id']])); ?>"><?php echo e($product['product_name'] .' - '. $product['variant_name']); ?></a>
                                                    </td>
                                                        ...
                                                        <?php if(!empty($product['tax'])): ?>
                                                            <?php $__currentLoopData = $product['tax']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                                    ...
                                                                    $total_tax += $sub_tax;
                                                                ?>
                                                                <p> <?php echo e($tax['tax_name'].' '.$tax['tax'].'%'.' ('.$sub_tax.')'); ?></p>
                                                    ...
                                                    <td data-label="Total">
                                                        <?php
                                                            ...
                                                            $total += $totalprice;
                                                        ?>
                                                        <p><?php echo e(\App\Models\Utility::priceFormat($totalprice)); ?></p>
                                            ...
                                            <?php else: ?>
                                                <tr data-id="<?php echo e($key); ?>">
                                                    ...
                                                    <td data-label="Total">
                                                        ...
                                                        ?>
                                                        <p><?php echo e(\App\Models\Utility::priceFormat($totalprice)); ?></p>
                                                        <a href="#" class="remove-btn" data-toggle="tooltip" data-original-title="<?php echo e(__('Move to trash')); ?>" data-confirm="<?php echo e(__('Are You Sure?').' | '.__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-product-cart-<?php echo e($key); ?>').submit();"><i class="fas fa-times"></i></a>
                                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['delete.cart_item',[$store->slug,$product['product_id'],$product['variant_id']]],'id'=>'delete-product-cart-'.$key]); ?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8 col-12">
                                <?php if($store_settings['is_checkout_login_required'] == null || $store_settings['is_checkout_login_required'] == 'off' && !Auth::guard('customers')->user()): ?>
                                    <a href="#" class="checkout-btn" data-modal="Checkout">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="price-bar">
                                    <span><?php echo e(__('Total value:')); ?></span>
...
<?php echo $__env->make('storefront.layout.theme4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/storefront/theme4/cart.blade.php ENDPATH**/ ?>