                ...
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01" style="flex-grow: 0;">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" href="/contact.html"><?php echo e(__('Support')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/terms.html"><?php echo e(__('Terms')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/privacy.html"><?php echo e(__('Privacy')); ?></a>
                            </li>
                        </ul>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer/resources/views/layouts/auth.blade.php ENDPATH**/ ?>