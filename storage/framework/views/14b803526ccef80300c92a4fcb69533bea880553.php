                                ...
                                <div class="menu-dropdown acnav-list">
                                    <ul>
                                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="<?php echo e(route('change.languagestore', [$store->slug, $language])); ?>"
                                                    class="<?php if($language == $currantLang): ?> active-language text-primary <?php endif; ?>"><?php echo e(Str::upper($language)); ?></a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/storefront/layout/theme1.blade.php ENDPATH**/ ?>