...
<html lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="public/style/images/favicon.ico" type="image/x-icon">
		<link rel="icon" href="public/style/images/favicon.ico" type="image/x-icon">
		<link rel="apple-touch-icon" sizes="152x152" href="public/style/images/apple-touch-icon-152x152.png">
		<link rel="apple-touch-icon" sizes="120x120" href="public/style/images/apple-touch-icon-120x120.png">
		<link rel="apple-touch-icon" sizes="76x76" href="public/style/images/apple-touch-icon-76x76.png">
		<link rel="apple-touch-icon" href="public/style/images/apple-touch-icon.png">
		<link rel="icon" href="public/style/images/apple-touch-icon.png" type="image/x-icon">
				 	...
				 	<!-- NAVIGATION MENU -->
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<!-- HEADER LOGO -->
	    					<div class="desktoplogo"><a href="#hero-6" class="logo-black"><img src="public/style/images/logo-small.png" alt="header-logo"></a></div>
	    					<div class="desktoplogo"><a href="#hero-6" class="logo-white"><img src="public/style/images/logo-small.png" alt="header-logo"></a></div>
			 		...
			 		<div class="row">
						<div class="col">
							<div class="img-block text-center video-preview wow fadeInUp">
								...
								<!-- Preview Image --> 
			 					<img class="img-fluid" src="public/style/images/dashboard-07.png" alt="video-preview">
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-7 col-lg-7">
								<div class="cta-11-txt">
									...
									<!-- Button -->
									<a href="pricing.html" class="btn btn-stateblue tra-stateblue-hover">Démarrer</a>
...
<?php /**PATH /home/you1deals/public_html/storebuilder.ma/resources/views/layouts/landing.blade.php ENDPATH**/ ?>