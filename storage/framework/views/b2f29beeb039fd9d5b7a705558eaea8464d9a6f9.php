                ...
                <div class="row align-items-center">
                    <div class="col-md-8 col-12">
                        <?php if($store_settings['is_checkout_login_required'] == null || $store_settings['is_checkout_login_required'] == 'off' && !Auth::guard('customers')->user()): ?>
                            <a href="#" class="checkout-btn modal-target" data-modal="Checkout">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('storefront.layout.theme1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/storefront/theme1/cart.blade.php ENDPATH**/ ?>