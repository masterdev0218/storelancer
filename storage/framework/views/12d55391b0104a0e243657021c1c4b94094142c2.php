            ...
            <div class="row align-items-center cart-head">
                ...
                <div class="col-lg-9 col-md-12 col-12 justify-content-end">
                    <div class="cart-btns">
                        ...
                        <a href="<?php echo e(route('user-address.useraddress', $store->slug)); ?>" class="active-btn">2 -<?php echo e(__('Customer')); ?></a>
                            ...
                            <div class="coupon-body">
                                <form action="">
                                    <div class="input-wrapper">
                                        <input type="text" id="stripe_coupon" name="coupon" class="coupon hidd_val" placeholder="<?php echo e(__('Enter Coupon Code')); ?>">
                            ...
                            <div id="cart-body" class="mini-cart-has-item">
                                ...
                                <div class="mini-cart-footer">
                                    ...
                                    <div class="u-save d-flex justify-content-between">
                                        ...
                                        <div class="cpn-price dicount_price"><?php echo e(\App\Models\Utility::priceFormat(0)); ?></div>
                                    </div>
...
<?php echo $__env->make('storefront.layout.theme4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/storefront/theme4/shipping.blade.php ENDPATH**/ ?>