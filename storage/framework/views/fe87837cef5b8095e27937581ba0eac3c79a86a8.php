        ...
        <div class="auth-content">
            <nav class="navbar navbar-expand-md navbar-light default">
                <div class="container-fluid pe-2">
                    ...
                    <?php if($setting['cust_darklayout'] == 'on'): ?>
                        <img src="<?php echo e(asset(Storage::url('uploads/logo/logo-light.png'))); ?>" alt=""
                            class="img-fluid" />
                    <?php else: ?>
                        <img src="<?php echo e(asset(Storage::url('uploads/logo/logo-dark.png'))); ?>" alt=""
                            class="img-fluid" />
                    <?php endif; ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/layouts/guest.blade.php ENDPATH**/ ?>