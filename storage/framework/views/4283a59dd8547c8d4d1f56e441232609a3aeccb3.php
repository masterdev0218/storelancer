...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(filter_var($_GET['email'] ?? '', FILTER_SANITIZE_SPECIAL_CHARS) ?? old('email')); ?>" required>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer/resources/views/auth/register.blade.php ENDPATH**/ ?>