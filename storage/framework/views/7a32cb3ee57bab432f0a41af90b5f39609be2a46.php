                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($order->payment_status == 'approved' && $order->status == 'pending'): ?>
                                                            <span class="badge me-2 rounded p-2  bg-light-primary"><?php echo e(__('Paid')); ?></span>
                                                            <?php echo e(\App\Models\Utility::dateFormat($order->created_at)); ?>

                                                        <?php else: ?>
                                                            <span class="badge me-2 rounded p-2  bg-light-secondary"><?php echo e(__('Delivered')); ?></span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/storelancer_new/resources/views/home.blade.php ENDPATH**/ ?>