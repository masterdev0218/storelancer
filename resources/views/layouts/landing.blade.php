	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-stateblue-hover">
								    ...
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="{{ route('login') }}" class="btn btn-stateblue tra-grey-hover last-link">Connexion</a>
								    </li> 
                                    @if(App\Models\Utility::getValByName('signup_button') == 'on')
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="{{ route('register') }}" class="btn btn-stateblue tra-grey-hover last-link">S'inscrire</a>
								    </li> 
								    @endif
									<!-- HEADER SOCIAL LINKS 													
						...
						<div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
							...
							<div class="col">
								<div class="footer-copyright">
									<p>&copy; {{__('Copyright')}} {{ (Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :config('app.name', 'storelancer') }} {{date('Y')}}</p>
								</div>
							</div>
