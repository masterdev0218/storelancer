...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme7/css/swiper.min.css') }}" id="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/theme7/css/purpose.css') }}" id="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/theme7/css/all.min.css') }}" id="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/theme7/css/storego.css') }}" id="stylesheet">
    {{-- <link rel="stylesheet" href="{{ asset('custom/css/custom.css') }}"> --}}


    <link rel="stylesheet"
        href="{{ asset('assets/theme7/css/' . (!empty($store->store_theme) ? $store->store_theme : 'black-color.css')) }}">
...
<body>
    ...
    <header class="header" id="header-main">
        ...
        <div
            class="menu-icon align-items-center border-bottom border-dark border-right d-none d-lg-flex justify-content-center">
            <span>
        ...
        <!-- Main navbar -->
        <nav class="navbar navbar-main navbar-expand-lg navbar-transparent py-2 py-lg-0" id="navbar-main">
        ...
        <div id="navbar-top-main" class="navbar-top bg-primary">
            <div class="container px-md-0 ml-lg-auto mr-lg-0 mr-xl-auto">
    ...
    <footer id="footer-main" class="mt-md-6 border-top border-dark">
        <div class="container">
            <div
                class="row pt-5  top-footer pb-0 {{ $getStoreThemeSetting[10]['section_enable'] == 'off' ? 'd-flex justify-content-end' : '' }}">

                <div class="col-lg-3 col-md-6 mb-4">
                    {{-- @DD($getStoreThemeSetting[10]) --}}
                    @if ($getStoreThemeSetting[10]['section_enable'] == 'on')
                        <img src="{{ $s_logo  . $getStoreThemeSetting[10]['inner-list'][0]['field_default_text']}}"
                            class="col-md-10 col-7 px-0 mb-4">
                        <p class="font-size-12 mb-4">
                ...
                @if ($getStoreThemeSetting[10]['section_enable'] == 'on')
                                ...
                                @if ($getStoreThemeSetting[11]['inner-list'][0]['field_default_text'] == 'on')
                                    @if (!empty($getStoreThemeSetting[11]))
                                        @if ((isset($getStoreThemeSetting[11]['section_enable']) &&
                                            ...
                                            <div class="col-6 col-lg-2 col-md-3 col-sm-4  ml-lg-auto text-center">

                                                @if ($getStoreThemeSetting[11]['inner-list'][0]['field_default_text'] == 'on')
                                                    <h6 class="font-size-12 heading ls-2 mb-3 text-uppercase">
                        ...
                        <div class="col-6 col-lg-2 col-md-3 col-sm-4  ml-lg-auto text-center">
                            @if ($getStoreThemeSetting[13]['inner-list'][0]['field_default_text'] == 'on')
                                @if ((isset($getStoreThemeSetting[13]['section_enable']) &&
                                    ...
                                    <h6 class="font-size-12 heading ls-2 mb-3 text-uppercase">
                                        {{ __($getStoreThemeSetting[13]['inner-list'][1]['field_default_text']) }}
                                    </h6>
                    ...
                    <div class="col-6 col-lg-2 col-md-3 col-sm-4 mb-4 text-center">
                        @if ($getStoreThemeSetting[15]['inner-list'][1]['field_default_text'] == 'on')
                            @if ((isset($getStoreThemeSetting[15]['section_enable']) &&
                                $getStoreThemeSetting[15]['section_enable'] == 'on') ||
                                $getStoreThemeSetting[15]['inner-list'][1]['field_default_text'])
                                <h6 class="font-size-12 heading ls-2 mb-3 text-uppercase">
                                    {{ __($getStoreThemeSetting[15]['inner-list'][0]['field_default_text']) }}
                                </h6>
                                <ul class="list-unstyled">
                                    @if (isset(
                                        ...
                                        @foreach ($getStoreThemeSetting[16]['homepage-header-quick-link-name-3'] as $name_key => $storethemesettingname)
                                            @foreach ($getStoreThemeSetting[16]['homepage-header-quick-link-3'] as $link_key => $storethemesettinglink)
                                                @if ($name_key == $link_key)
                                                    <li>
                                                        <a class="font-size-12" href="{{ $storethemesettinglink }}">
                                                            {{ $storethemesettingname }}
                                                        </a>
                                                    </li>
                                                @endif
                                    ...
                                    @else
                                        @for ($i = 0; $i < $getStoreThemeSetting[16]['loop_number']; $i++)
                                            <li><a class="font-size-12 text-secondary"
                                                    ...
                                                    {{ $getStoreThemeSetting[16]['inner-list'][0]['field_default_text'] }}</a>
                                            </li>
                                        @endfor
                                    @endif
                    ...
                    @if (isset($storethemesetting['section_name']) &&
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="d-flex form-group">
                                ...
                                <button class="border-0 btn btn-primary px-3 rounded-0">
                                            ...
                                            @if (isset($getStoreThemeSetting[18]['inner-list'][1]['field_default_text']) &&
                                                ...
                                                <li class="d-inline-block mr-2">
                                                    <a class="d-flex align-items-center justify-content-center footer-icon"
                                                        href="{{ $getStoreThemeSetting[18]['inner-list'][1]['field_default_text'] }}"
                                                        target="_blank">
