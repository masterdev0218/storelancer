                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9 col-lg-10">
                        <div class="nav nav-tabs nav-fill border-0" id="nav-tab" role="tablist">
                            <div class="payment-step border border-secondary row no-gutters w-100 overflow-hidden rounded-pill">
                                <div class="col-sm-4">
                                        <a href="{{ route('store.cart', $store->slug) }}"  class="active-a tab-a border-0 btn btn-block text-secondary m-0 rounded-0 rounded-pill">1 -
                                            {{ __('My Cart') }}</a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="{{ route('user-address.useraddress', $store->slug) }}" class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0 rounded-pill">2 -
                                            {{ __('Customer') }}</a>
                                </div>
                                <div class="col-sm-4">
                                        <a href="{{ route('store-payment.payment', $store->slug) }}" class="border-0 tab-a btn btn-block m-0 text-secondary rounded-0 rounded-pill">3 -
                                            {{ __('Payment') }}</a>
                                </div>
                            </div>
                        </div>
