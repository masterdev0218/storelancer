        ...
        @if (Auth::user()->type == 'Owner')
            <li class="nav-item">
                <a class="nav-link active" id="pills-theme_setting-tab" data-bs-toggle="pill" href="#pills-theme_setting"
                    role="tab" aria-controls="pills-theme_setting" aria-selected="true">{{ __('Theme Settings') }}</a>
            </li>
            <li class="nav-item">
                                                            ...
                                                            <div class="col-6 py-2 text-end">
                                                                <div class="form-check form-switch form-switch-right mb-2">
                                                                    ...
                                                                    <input type="checkbox" class="form-check-input mx-2"
                                                                        ...
                                                                        {{ isset($store_settings['is_rapyd_enabled']) && $store_settings['is_rapyd_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                                                    <label class="form-check-label"
                                                                        for="is_rapyd_enabled">{{ __('Enable') }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 pb-4">
                                                                <label class="paypal-label col-form-label"
                                                                    for="rapyd_mode">{{ __('Rapyd Mode') }}</label>
                                                                <br>
                                                                <div class="d-flex">
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label class="form-check-labe text-dark">
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        class="form-check-input"
                                                                                        {{ !isset($store_settings['rapyd_mode']) || $store_settings['rapyd_mode'] == '' || $store_settings['rapyd_mode'] == 'sandbox' ? 'checked="checked"' : '' }}>
                                                                                    {{ __('Sandbox') }}
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label class="form-check-labe text-dark">
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        class="form-check-input"
                                                                                        {{ isset($store_settings['rapyd_mode']) && $store_settings['rapyd_mode'] == 'live' ? 'checked="checked"' : '' }}>
                                                                                    {{ __('Live') }}
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="rapyd_client_id"
                                                                        ...
                                                                        value="{{ !isset($store_settings['rapyd_client_id']) || is_null($store_settings['rapyd_client_id']) ? '' : $store_settings['rapyd_client_id'] }}"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="rapyd_secret_key"
                                                                        ...
                                                                        value="{{ !isset($store_settings['rapyd_secret_key']) || is_null($store_settings['rapyd_secret_key']) ? '' : $store_settings['rapyd_secret_key'] }}"
